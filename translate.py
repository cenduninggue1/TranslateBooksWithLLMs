...
from src.config import DEFAULT_MODEL, API_ENDPOINT, LLM_PROVIDER, GEMINI_API_KEY, OPENAI_API_KEY, OPENROUTER_API_KEY, MISTRAL_API_KEY, DEEPSEEK_API_KEY, POE_API_KEY, NIM_API_KEY, DEFAULT_SOURCE_LANGUAGE, DEFAULT_TARGET_LANGUAGE, PARALLEL_REQUESTS, PARALLEL_REQUESTS_MAX
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help=(
            f"Number of translation segments to dispatch concurrently against the LLM "
            f"(default: {PARALLEL_REQUESTS}, max: {PARALLEL_REQUESTS_MAX}). "
            f"Ignored for local providers (e.g. ollama)."
        ),
    )
